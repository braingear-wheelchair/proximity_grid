#ifndef PROXIMITY_GRID_LASERSCANTOPROXIMITYSECTOR_CPP
#define PROXIMITY_GRID_LASERSCANTOPROXIMITYSECTOR_CPP
...
LaserScanToProximityGrid::LaserScanToProximityGrid(void) : private_nh_("~") {
    ...
    this->pub_ = this->nh_.advertise<proximity_grid::ProximityGridMsg>(this->pub_topic_, 1);
...
void LaserScanToProximityGrid::Run(void) {
	...
	proximity_grid::ProximityGridMsg		grid_msg;	
...
void LaserScanToProximityGrid::on_dynamic_reconfiguration(proximity_grid::LaserScanGridConfig &config, uint32_t level) {
