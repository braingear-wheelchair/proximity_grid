#ifndef PROXIMITY_GRID_POINTTOPROXIMITYGRID_CPP
#define PROXIMITY_GRID_POINTTOPROXIMITYGRID_CPP
...
PointToProximityGrid::PointToProximityGrid(void) : private_nh_("~") {
    ...
    this->pub_ = this->nh_.advertise<proximity_grid::ProximityGridMsg>(this->ptopic_, 1);
...
void PointToProximityGrid::on_dynamic_reconfiguration(proximity_grid::PointGridConfig &config, uint32_t level) {
