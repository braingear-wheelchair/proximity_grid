#ifndef PROXIMITY_GRID_PROXIMITYGRIDVISUALIZER_CPP
#define PROXIMITY_GRID_PROXIMITYGRIDVISUALIZER_CPP
...
void ProximityGridVisualizer::on_received_grid(const proximity_grid::ProximityGridMsg& msg) {
